...
Config.Objects = {
    {label = "Police Barrier", object = "prop_barrier_work05"},
    {label = "Big Cone", object = "prop_roadcone01a"},
    {label = "Small Cone", object = "prop_roadcone02b"},
    {label = "Gazebo", object = "prop_gazebo_02"},
    {label = "Scene Lights", object = "prop_worklight_03b"},
}
...
Config.Locale = GetConvar('esx:local', 'en') --Translation
